...
export class ProjectDataManager {
  ...
  initialize(r2Url: string): void {
    ...
    try {
      ...
      console.log("✅ ProjectDataManager initialized with URL:", r2Url);
    } catch (error) {
...
export const initializeProjectData = (r2Url: string) =>
  projectDataManager.initialize(r2Url);
export const updateProjectDataUrl = (newR2Url: string) =>
  projectDataManager.updateUrl(newR2Url);
...
export const testProjectDataConnection = () =>
  projectDataManager.testConnection();
